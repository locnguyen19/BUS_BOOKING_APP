...
function BookNow() {
  ...
  //GETTING BUS DATA FROM THE BACKEND WITH ITS ID
  const getBus = async () => {
    try {
          ...
          <Col lg={12} xs={24} sm={24}>
            ...
            <hr />
             ...
             <div className="flex flex-col gap-2">
              ...
              <h1 className="text-2xl mt-2">
                Total Fare : {bus.fare * selectedSeats.length} 
              </h1>
              <hr />
              ...
              <StripeCheckout
                ...
                currency="usd"
                stripeKey="pk_test_51MHBXrKmuaKyP9UxIIodImjI2jG6LuJjwW6hOyIgPR4P2JazFCRUHPVeB1jYKNIA0bDuGQBF4ZZtfLApZZryYyW500l1XN0OPR"
              >
                <button
